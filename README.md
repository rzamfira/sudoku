...
state.js -> define the initial state:
...
grid.js -> create the grid structure ( to keep track of the cell numbers )
	    -> render the values 
...
puzzle.js -> handle player input ( can come from keyboard, from numpad buttons or from undo, erase, notes buttons )
...
sudokuGenerator.js -> generate puzzle
		           -> solution
